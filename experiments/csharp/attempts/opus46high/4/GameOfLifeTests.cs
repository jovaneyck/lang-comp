...
public class GameOfLifeTests
{
    ...
    [Fact]
    public void Dead_cell_with_exactly_three_zombie_neighbors_becomes_alive()
    {
    ...
    [Fact]
    public void Live_cell_surrounded_by_four_plus_zombies_dies()
    {
        var input = MakeGrid([[Z, Z, O], [Z, X, Z], [O, O, O]]);
        var expected = MakeGrid([[Z, Z, X], [Z, O, Z], [O, X, O]]);
        AssertGridsEqual(expected, input.Tick());
    }
