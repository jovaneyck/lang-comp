...
public class GameOfLifeTests
{
    ...
    {
        var input = MakeGrid([[X, X, X], [X, Z, X], [O, O, O]]);
        var expected = MakeGrid([[X, O, X], [X, Z, X], [O, X, O]]);
        AssertGridsEqual(expected, input.Tick());
    }
    ...
    {
        var input = MakeGrid([[Z, Z, Z], [Z, X, O], [O, O, O]]);
        var expected = MakeGrid([[Z, Z, Z], [Z, O, X], [O, O, O]]);
        AssertGridsEqual(expected, input.Tick());
    }

    [Fact]
    public void Mixed_grid_tick()
    {
        var input = MakeGrid([
            [O, O, X, O, O, O, Z, O, O],
            [O, O, O, X, O, O, O, O, O],
