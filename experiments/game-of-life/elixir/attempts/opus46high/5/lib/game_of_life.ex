defmodule GameOfLife do
  ...
  @spec tick(matrix :: list(list(0 | 1 | :zombie))) :: list(list(0 | 1 | :zombie))
  def tick([]), do: []
  ...
  defp count_neighbors(matrix) do
    ...
    shift_left = shift_left(binary)
    shift_right = shift_right(binary)
