...
#[test]
fn conjured_item_before_sell_date() {
...
#[test]
fn conjured_item_after_sell_date() {
...
#[test]
fn conjured_item_quality_never_negative() {
    let items = vec![
    ...
    assert_eq!(rose.items[1].quality, 0);
